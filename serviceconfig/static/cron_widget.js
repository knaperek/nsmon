...
$(document).ready(function() {
	...
	$("#id_CRON_string").next().after('<div id="cc_wrapper"></div>');
	cronCalendar($("#id_CRON_string"), $("#cc_wrapper"));
...
function cronCalendarElement(calendar, index, nameLabel, minValue, maxValue, valueLabels) {
	...
	this.id = "cc_" + this.name.toLowerCase();
	this.size = 10;
	var me = this;
	...
	this.htmlBase = $('<div>').attr('id', this.id).addClass('cc_element')
