# Django settings for nsmon project.
import os
...
# USE_TZ = True # TODO: pouzit True, ked sa to uspesne premigruje (upravit json serializeri, ...)
USE_TZ = False
...
SECRET_KEY = 'dtq#tzrh#*ww76=u0luv8swxl8-hi9=ohxj$cq4cep1to)xlw&amp;'
...
ROOT_URLCONF = 'nsmon.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'nsmon.wsgi.application'
